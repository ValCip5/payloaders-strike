  ...
  return (
    <section id="trailer" className="trailer">
      <Container>
        ...
        <iframe src="https://www.youtube.com/embed/yrT6l3ffLO4" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>

  ...
  return (
    <section id="trailer" className="trailer">
      <Container>
        ...
        <iframe src="https://www.youtube.com/embed/PylG9sSBtcg" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
